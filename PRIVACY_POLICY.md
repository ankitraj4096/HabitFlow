...
- **Timed task management** with visual progress tracking
- **Tier-based progression system** that rewards consistency
- **Social accountability features** to connect with friends
- **Friendly competition** through achievements and shared progress
- **Personalized themes** that unlock as you progress
...
- Timer durations and elapsed time
...
### 4. Progress and Achievement Data
- Tier progression (based on completed tasks)
...
**Important:** We do **NOT** collect browsing history, location data, or sell your information to third parties.
...
- **Provide core app functionality** - Task management, timers, and synchronization
- **Enable social features** - Friend connections, task assignments, and shared achievements
- **Personalize your experience** - Theme selection, tier progression, and customized notifications
- **Maintain app security** - Account authentication and data protection
- **Improve app performance** - Bug fixes, crash reports, and stability improvements
...
### Storage Location
- **Firebase Firestore** - Your task data, profile information, and social connections are stored securely in Google's Firebase infrastructure
...
- **Access Control** - Only you and friends you explicitly connect with can access your task data
...
- **Friends' access** - Limited to username, tier level, completed task count, and tasks they assign to you
...
- Your username
- Your current tier and tier name
...
### Access Your Data
- View all your tasks, friends, and statistics within the app
...
- Modify task data, friend connections, and theme preferences
...
- You can delete tasks, friends, or your entire account at any time
